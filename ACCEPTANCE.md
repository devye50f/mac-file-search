...
- GUI currently exposes a single criterion. It can add/remove multiple folder or volume scopes and remembers their paths, but security-scoped bookmark identity, nested builder, excluded-subtree editor, Advanced controls, saved-search management, highlighted snippets/captures, and Finder-tag controls need wiring.
